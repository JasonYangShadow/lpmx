...
```
**NOTE** users may not need to modify configuration files themselves in principle unless you clearly know what you want. Most items in configuration file are set and configurated by LPMX itself, any new value will overrite default one. Therefore, if any errors occur after modification, please empty configuration file and recreate your container.
