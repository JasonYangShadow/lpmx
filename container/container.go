...
func (con *Container) genEnv() (map[string]string, *Error) {
	...
	env["FAKECHROOT_CMD_SUBST"] = "/sbin/ldconfig.real=/bin/true:/sbin/insserv=/bin/true:/sbin/ldconfig=/bin/ldconfig:/usr/bin/ischroot=/bin/true:/usr/bin/mkfifo=/bin/true"
